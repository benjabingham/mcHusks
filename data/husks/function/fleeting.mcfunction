...
execute if score @s timeAlive matches ..-800000 run scoreboard players add @s timeAlive 60
execute if score @s timeAlive matches -800000..0 run scoreboard players add @s timeAlive 40
execute if score @s timeAlive matches 0..1200000 run scoreboard players add @s timeAlive 12
