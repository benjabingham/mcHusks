...
execute if score @s lifePercent matches 40..49 run scoreboard players add @s timeAlive 9
...
execute if score @s lifePercent matches 10..19 run scoreboard players add @s timeAlive 6
