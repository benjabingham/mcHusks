...
execute if score @s lifePercent matches 1.. run effect give @s absorption 1800
...
execute if score @s lifePercent matches 25.. run effect give @s regeneration 600
