execute as @a at @s run summon wither_skeleton ~ -100 ~ {DeathLootTable:"husks:witherarcher", PersistenceRequired:1b,Tags:["archers-to-teleport","summoned"], equipment:{mainhand:{id:"minecraft:bow",count:1},drop_chances:{mainhand:0.000}},CustomNameVisible:0b,CustomName:"Wither Imp",attributes:[{id:"minecraft:scale",base:0.5},{id:"max_health",base:11}],Team:HideNames}
