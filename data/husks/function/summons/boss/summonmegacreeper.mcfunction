summon creeper ~ -100 ~ {DeathLootTable:"husks:boss/megacreeper", ExplosionRadius:6b,PersistenceRequired:1b,Tags:["creepers-to-teleport","creeper-boss","summoned"],CustomNameVisible:0b,CustomName:"Megacreeper",attributes:[{id:"minecraft:scale",base:5},{id:"max_health",base:80},{id:"minecraft:jump_strength",base:1},{id:"minecraft:fall_damage_multiplier",base:0},{id:"follow_range",base:100},{id:"movement_speed",base:0.30}]}
