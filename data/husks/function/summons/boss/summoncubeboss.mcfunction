summon magma_cube ~ -100 ~ {Size:8, DeathLootTable:"husks:boss/cubeboss",PersistenceRequired:1b,Tags:["cubes-to-teleport","cube-boss","summoned"],CustomNameVisible:0b,CustomName:"Corrupting Cube",attributes:[{id:"follow_range",base:100}],Team:HideNames}
