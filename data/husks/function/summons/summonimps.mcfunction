...
summon wither_skeleton ~ -100 ~ {CustomNameVisible:0b,CustomName:"Wither Imp",Tags:["summoned"],attributes:[{id:"minecraft:scale",base:0.5},{id:"max_health",base:3},{id:"attack_damage",base:1}]}
