...
execute if dimension minecraft:overworld as @s[distance=0..] if score @s totalSouls matches 2.. run execute if score ☻ souls matches 2.. run function husks:summons/disturb
